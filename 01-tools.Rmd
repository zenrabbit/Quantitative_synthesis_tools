...
# Quantitative synthesis tools {#tools}
...
### Context {-}  
To best explore conceptual and mental models for synthesis, a summary of the simple landscape of opportunities and more comprehensive mapping of synthesis and critical big-picture thinking in science is illuminating. Scientific synthesis is [big picture, formal science](https://onlinelibrary.wiley.com/doi/full/10.1111/j.1600-0706.2013.00970.x) that describe a set of studies on a pinpointed topic [@RN3216]. There are at least three simple and direct options that are amenable to a capture of the research associated with a scientific challenge that you have identified.  
...
#### Evidence framing {-}  
A more complex and comprehensive summary of the contemporary landscape of synthesis has been evolving. Framing scientific synthesis activities as an open, comprehensive, and diverse aggregation or summary of many forms of evidence expands our capacity to inform decision making. Contemporary synthesis science has innovated on evidence maps as a tool to show the evidence. This can be done through [mapping evidence onto a geographic map](https://www.nature.com/articles/528185a) to show where we know what we know [@RN3621]. Evidence maps can also be less literal and map out [knowledge as tabular or bubble plots](https://systematicreviewsjournal.biomedcentral.com/articles/10.1186/s13643-016-0204-x) that focus more on the relative frequencies of what we know about different concepts within a synthesis [@RN4430]. This approach has also been framed as 'evidence maps for evidence gaps' because it can become abundantly clear [where evidence is missing in terms of research or ideas](https://environmentalevidencejournal.biomedcentral.com/articles/10.1186/s13750-017-0096-9) [@RN5998]. Importantly, decision making has also evolved to [more substantially rely on synthesis science](https://conbio.onlinelibrary.wiley.com/doi/full/10.1111/csp2.426) to inform strategy [@RN7304]. There has also been a drive to thus enable and support more synthesis to build capacity and [connect disparate fields of research](https://onlinelibrary.wiley.com/doi/full/10.1111/rec.13251) for more holistic solution sets [@RN7323].  
